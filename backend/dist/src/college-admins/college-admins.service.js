...
exports.CollegeAdminsService = void 0;
...
let CollegeAdminsService = class CollegeAdminsService {
    prisma;
    constructor(prisma) {
        this.prisma = prisma;
    }
    ...
    async findOne(id) {
        ...
        if (!admin)
            throw new common_1.NotFoundException('College admin not found');
        return admin;
    }
    async update(id, dto) {
...
exports.CollegeAdminsService = CollegeAdminsService;
exports.CollegeAdminsService = CollegeAdminsService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], CollegeAdminsService);
//# sourceMappingURL=college-admins.service.js.map