          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500 mt-2 leading-relaxed">
                {orgName ? <><strong className="text-slate-700">{orgName}</strong> is live.</> : "Your organization is live."}
                {typeLabel ? <> Type: {typeLabel}.</> : null}
                {" "}We collect only the fields that matter for safety work — identity, role, location, and emergency contacts — and keep medical data for SOS only.
              </p>
            </div>
        ...
        {step === 1 && (
          <div className="space-y-5">
            ...
            <p className="text-sm text-slate-500">
              These forms follow the organization type you picked{typeLabel ? ` (${typeLabel})` : ""}. You can edit them later in Settings.
            </p>
